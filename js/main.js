...
function initThemeToggle() {
  ...
  // Add fixed toggle button if not already present
  if ($('#themeToggle').length === 0) {
    const toggleBtn = $('<button class="theme-toggle" id="themeToggle" aria-label="Toggle dark mode"><i class="fas fa-moon" id="themeIcon"></i></button>');
